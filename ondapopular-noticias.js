...
const FACEBOOK_PAGE_ID = process.env.FACEBOOK_PAGE_ID_ONDAPOPULAR_NOTICIAS;
const FACEBOOK_ACCESS_TOKEN = process.env.FACEBOOK_ACCESS_TOKEN_ONDAPOPULAR_NOTICIAS;
const PUBLISH_TO_STORY = true;

// Configuración de imagen (similar a tu plugin)
const IMAGE_CONFIG = {
    width: 720,
    height: 1280,
    logoUrl: 'https://radioondapopular.com/wp-content/uploads/2025/05/logo-noticias.png',
...
async function generateImage(post) {
    ...
    const category = 'DESTACADO'; // Puedes personalizar esto según las categorías del post
            ...
            <head>
                ...
                <style>
                    ...
                    .background-overlay {
                        ...
                        width: 100%;
                        height: 100%;
                        background: linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.3) 50%, rgba(0,0,0,0.7) 80%);
                        z-index: 1;
                    }
                    .logo-container {
                        position: absolute;
                    ...
                    .corner-decoration {
                        ...
                        width: 120px;
                        height: 120px;
                        border: 3px solid ${IMAGE_CONFIG.categoryBgColor};
                        z-index: 2;
                    }
                    .corner-tl {
                        top: -8px;
                    ...
                    .category-badge {
                        background: ${IMAGE_CONFIG.categoryBgColor};
                        color: ${IMAGE_CONFIG.categoryTextColor};
                        padding: 10px 20px;
                    ...
                    .title {
                        ...
                        font-family: ${IMAGE_CONFIG.titleFontFamily};
                        position: relative;
                        max-width: 90%;
                    }
                    .title::after {
